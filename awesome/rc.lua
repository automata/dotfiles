...
modkey     = "Mod4"
altkey     = "Mod1"
terminal   = "gnome-terminal --zoom=0.9"
editor     = "atom"
...
globalkeys = awful.util.table.join(
    ...
    awful.key({}, "XF86MonBrightnessUp",
      function ()
        os.execute("/home/vilson/bin/mon_up.sh")
      end),
    awful.key({}, "XF86MonBrightnessDown",
      function ()
        os.execute("/home/vilson/bin/mon_down.sh")
      end),
    awful.key({}, "XF86KbdBrightnessUp",
      function ()
        os.execute("/home/vilson/bin/kbd_up.sh")
      end),
    awful.key({}, "XF86KbdBrightnessDown",
      function ()
        os.execute("sudo /home/vilson/bin/kbd_down.sh")
      end)
)
